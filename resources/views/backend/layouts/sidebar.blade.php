<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{Request::is('admin/studentclass*')? 'active' : ''}}">
                <a href="{{route('admin.studentclass.index')}}">
                    <i class="material-icons">text_fields</i>
                    <span>All Class List</span>
                </a>
            </li>
            <li class="{{Request::is('admin/district*')? 'active' : ''}}">
                <a href="{{route('admin.district.index')}}">
                    <i class="material-icons">layers</i>
                    <span> All District List</span>
                </a>
            </li>

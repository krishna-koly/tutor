...
@section('content')
                            ...
                            <div class="row-clearfix">
                             ...
                             <div class="col-sm-12">
                            <label for="product"> Select A Class: </label>
                        </div>
                            ...
                            <select name="studentclass_id" class="form-control show-tick" data-live-search="true">

                            @foreach($studentclass as $studentcls)

                            <option value="{{$studentcls->id}}">{{$studentcls->name}}</option>
                            ...
                            @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <span> <label for="area_name">Enter Subject Name :</label></span><input type="text" name="name" id="subject_name" class="form-control">
                                        </div>
                                    </div>

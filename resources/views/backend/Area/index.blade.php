...
@section('content')
    ...
    <div class="container-fluid">
            <div class="block-header">
                <h2>
           <a href="{{route('admin.area.create')}}" class="btn btn-info" >Add new Area </a>
                </h2>
            </div>
...
<td>
<a href="{{route('admin.area.edit', $area->id )}}" class="btn btn-info btn-xs"><i class="material-icons">edit</a>

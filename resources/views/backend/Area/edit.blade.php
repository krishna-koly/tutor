...
@section('content')
                            ...
                            <div class="row clearfix">
                            <form action="{{ route('admin.area.update',$areas->id) }}" method="post">
                          ...
                          @foreach($districts as $district)
                            ...
                            @if($areas->district->id == $district['id'])
                                  selected
                                  @endif
                                >{{$district['name']}}
                            ...
                            @endforeach
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <span> <label for="area_name">Enter Area Name :</label></span>    <input type="text" name="name" value="{{ $areas->name}}" class="form-control">
                                        </div>
                                    </div>

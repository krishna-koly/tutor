...
@section('content')
                            ...
                            <div class="row clearfix">
                            <form action="{{route('admin.other.update',$others->id)}}" method="post">
                            ...
                            @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                        <span> <label for="other_name">Enter Title :</label></span><input type="text" name="name" value="{{ $others->name}}" id="other_name" class="form-control">
                                        </div>
                                    </div>
